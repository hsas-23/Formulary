...
- 実臨床での意思決定を支援し、また院内での抗菌薬投与方法を標準化することを目的としている
- 各薬剤は構造化データ（YAML）に基づき整理されている
- 必要に応じて、最新のエビデンスに基づき更新されている

---

## ⚠️ 注意事項

- 本内容は医療者向けであり、最終的な治療判断は臨床状況に基づいて行うこと  
- 個別症例においては専門医へのコンサルトを推奨する  
