...
#### グラム陰性菌
- *Haemophilus influenzae*（βラクタマーゼ非産生株）
- *Escherichia coli*（βラクタマーゼ非産生株）
- *Proteus mirabilis*
- *Salmonella* 属、*Shigella* 属
...
#### βラクタマーゼ産生菌
- 多くの *E. coli*、*H. influenzae*（BLNAR, BLPAR, BLPACR）、*Klebsiella* 属

#### 本質的耐性
- MRSA
- 緑膿菌
- *Serratia*、*Enterobacter*、*Citrobacter* 属
- 腸球菌でも、*Enterococcus faecium*には基本的に無効と考えておくとよい<br>
  （例外的に、5%程の頻度で、アンピシリンが有効な*E. faecium*も存在する）
...
| CrCl (mL/min) | 通常用量 | 重症用量 |
|---|---|---|
| ≥50 | 1–2 g 6時間ごと | 2 g 4時間ごと |
| 30–49 | 1–2 g 8時間ごと | 2 g 6時間ごと |
| 15–29 | 1–2 g 12時間ごと | 2 g 8時間ごと |
| <15 | 1–2 g 24時間ごと | 2 g 12時間ごと |

---

#### 血液透析（HD）
- 1–2 g 24時間ごと（重症時：2 g 12時間ごと）
- 透析除去率：約40–60%
- 透析日は透析終了後に投与
